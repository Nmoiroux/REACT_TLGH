...
- database `Data.RData` (epidemiological data) and `Data2.RData` (LLIN use data) are pseudonymized data and required to fill in and sign the Data Share Agreement before sharing (See `DataUseAgreement_doi_10_23708_MZ7KZZ.docx`).
